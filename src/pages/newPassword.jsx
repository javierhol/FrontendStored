     ...
     <div className='bg-gray-100 h-screen relative'>
          ...
          <div className="bg-white w-4/5 sm:w-[30rem] rounded mt-9 mx-auto p-1  my-3">
              ...
              <div className="text-gray-600 my-3 mx-2">
                 Ya casi terminamos ingresa tu nueva contraseña para poder acceder a tu cuenta
              </div>
              <Formik
                        initialValues={{
            password: "",
             password2: "",
                        ...
                        validationSchema={Yup.object( {
                            password: Yup.string().min(6,"La contraseña debe tener mas de 6 digitos")
                                .required( "El campo no puede estar vacio" ),
                            password2: Yup.string().min(6,"La contraseña debe tener mas de 6 digitos")
                                .required( "El campo no puede estar vacio" ).oneOf([Yup.ref('password'), null], 'Las contraseñas no coinciden'),
                        } )}
          onSubmit={async ( values ) => {
            let cod = localStorage.getItem( 'codigo' )
            let email = localStorage.getItem( 'email' )
                       const response =await newPasswordL({codigo:parseInt(cod), correo:email, newPassword:values.password2})
